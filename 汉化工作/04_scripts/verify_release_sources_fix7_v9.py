...
# auxiliary QA
kq=json.loads((R/'05_build/keyword_fix6/keyword_fix6_qa.json').read_text(encoding='utf-8'));iq=json.loads((R/'05_build/fix6_exefs/FINAL_IPS_QA_fix6.json').read_text(encoding='utf-8')); nq=json.loads((R/'05_build/fix7_name_qa.json').read_text(encoding='utf-8'));bq=json.loads((R/'05_build/button_fix5/button_fix5_ocr_qa.json').read_text(encoding='utf-8'));fq=json.loads((R/'05_build/font_package_fix2/font_final_qa_fix2.json').read_text(encoding='utf-8'));cq=json.loads((R/'05_build/config_fix4_static_qa.json').read_text(encoding='utf-8'));tq=json.loads((R/'05_build/title_fix3_ocr_qa.json').read_text(encoding='utf-8'))
